...
class TestAdvancedControls(unittest.TestCase):
    ...
    # Test absolute click functionality
    @patch('src.core.windows_controller.WindowsController._execute_powershell')
    def test_click_abs_success(self, mock_execute_ps):
        """Test successful absolute clicking."""
        mock_execute_ps.return_value = "SUCCESS: Clicked at (100, 200)"

        result = self.controller.click_abs(100, 200)

        self.assertTrue(result.success)
        self.assertEqual(result.operation, "click_abs")
    ...
    @patch('src.core.windows_controller.WindowsController._execute_powershell')
    def test_click_abs_failure(self, mock_execute_ps):
        """Test clicking failure scenario."""
        mock_execute_ps.return_value = "ERROR: Click failed"
    ...
    @patch('src.core.windows_controller.WindowsController._execute_powershell')
    def test_click_abs_coordinates_validation(self, mock_execute_ps):
        """Test clicking with various coordinate values."""
        mock_execute_ps.return_value = "SUCCESS: Clicked at (0, 0)"

        # Test edge coordinates
        result = self.controller.click_abs(0, 0)
        self.assertTrue(result.success)

        # Test large coordinates
        mock_execute_ps.return_value = "SUCCESS: Clicked at (1920, 1080)"
        result = self.controller.click_abs(1920, 1080)
        self.assertTrue(result.success)

    # Test text typing functionality
    @patch('src.core.windows_controller.WindowsController.click_abs')
    @patch('src.core.windows_controller.WindowsController._execute_powershell')
    def test_type_text_success(self, mock_execute_ps, mock_click_abs):
        """Test successful text typing."""
        # Mock successful click
        mock_click_abs.return_value = ExecutionResult.success_result(
            "click_abs", "screen", "Clicked successfully"
        )
        ...
        mock_click_abs.assert_called_once_with(50, 100)

    @patch('src.core.windows_controller.WindowsController.click_abs')
    def test_type_text_click_failure(self, mock_click_abs):
        """Test text typing when initial click fails."""
        # Mock failed click
        mock_click_abs.return_value = ExecutionResult.failure_result(
            "click_abs", "screen", "Click failed"
        )
    ...
    @patch('src.core.windows_controller.WindowsController.click_abs')
    @patch('src.core.windows_controller.WindowsController._execute_powershell')
    def test_type_text_special_characters(self, mock_execute_ps, mock_click_abs):
    ...
    def test_execute_action_click_abs(self):
        """Test execute_action with CLICK_ABS."""
        with patch.object(self.controller, 'click_abs') as mock_click_abs:
            mock_click_abs.return_value = ExecutionResult.success_result(
                "click_abs", "screen", "Clicked successfully"
            )
            ...
            mock_click_abs.assert_called_once_with(100, 200)
            self.assertTrue(result.success)
    ...
    def test_advanced_control_workflow(self, mock_execute_ps):
        ...
        click_result = self.controller.click_abs(100, 200)
